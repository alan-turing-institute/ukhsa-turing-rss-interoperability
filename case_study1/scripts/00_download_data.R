...
path_to_pillar12 <- "data/testing/Demographic_LA_tables.ods"
...
for(round in 1:13) {
  ...
  path_to_local_age_file <- file.path("data/react", file_name_curr)
...
path_to_weekly_vax <- "data/covariates/COVID-19-weekly-announced-vaccinations.xlsx"
...
path_to_ons_pop <- "data/covariates/ukmidyearestimates20192020ladcodes.xls"
...
path_to_lookup <- "data/geography/Local_Authority_District_to_Region__December_2020__Lookup_in_England.csv"
...
temp <- tempfile()
path_to_shapefile <- "data/geography/Local_Authority_Districts_(May_2020)_Boundaries_UK_BFE-shp"
...
for (i in 1:nrow(epi_in_tab)) {
  ...
  path_to_epimap <- "data/epimap/Rt_estimates_Epimap.csv"
  download.file(url_to_epimap, path_to_epimap)
  rd <- read.csv("data/epimap/Rt_estimates_Epimap.csv", stringsAsFactors = F)
...
path_to_combined_epimap <- "data/epimap/Rt_estimates_Epimap_combined.csv"
...
path_to_sanger <- "data/covariates/UK_variant_data_Sanger.tsv"
